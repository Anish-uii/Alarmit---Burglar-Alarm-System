...
// Check if user is already registered, if true, redirect to home page.
...
<head>
    ...
    <title>Alarmit.com - Sign Up</title>
</head>
...
<body>
    <section class="center-container">
        ...
        <section class="image-container">
            <img src="<?php echo ROOT ?>/assets/images/eyeglasses.png" alt="">
        </section>
    </section>
