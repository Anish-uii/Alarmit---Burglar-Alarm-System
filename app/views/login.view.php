    ...
    <section class="center-container">
      <section class="container">
        <form action="" class="name-form" method='post'>
          ...
          <a class="google-btn" href="<?php echo ROOT ?>/loginwithgoogle"><img id="google-img" src="<?php echo ROOT ?>/assets/images/google.png" alt="Google Logo">
            Google Login</a>

          <span class='signup-link'>Don't have an account ?
            <a href="<?php echo ROOT ?>/signup">Register from here</a>
          </span>
        </form>
      </section>
