...
trait User
{
    ...
    public function googleLogin()
    {
        ...
        $google_client->setRedirectUri('http://alarmit.com/loginwithgoogle');
    ...
    public function emailValidation($email)
    {
        ...
        curl_setopt_array($curl, [
            CURLOPT_URL => "https://emailvalidation.abstractapi.com/v1/?api_key=yourAPIKey&email=$email",
    ...
    public function sendEmail($email, $name, $token)
    {
        ...
        try {
            ...
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('youremail@mail.com', 'Your Name');
